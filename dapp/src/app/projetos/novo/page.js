...
export default function Home() {
  ...
  function salvar() {
    cadastrarNovoProjeto([
      ...
      formulario.meta_valor_arrecadacao * 10**18,
    ...
    ], 'carro, tesla').then(dados => { console.log(dados); push('/projetos'); }).catch(dados => { alert("Erro, verifique se os dados estão corretamente preenchidos."); console.log(dados) })
            ...
            <div class="border-b border-gray-900/10 pb-12">
              <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div class="sm:col-span-3">
                  ...
                  <div class="mt-2">
                    <input required id="imagem" value={formulario.imagem} onChange={handleChange} name="imagem" type="text" autocomplete="imagem" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                  </div>
                ...
                <div class="sm:col-span-9">
                  ...
                  <div class="mt-2">
                    <input required id="site" value={formulario.site} onChange={handleChange} name="site" type="text" autocomplete="imagem" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                  </div>
                  <p class="mt-3 text-sm leading-6 text-gray-600">Utilize uma url curta ou um encurtador.</p>
                </div>
                ...
                <div class="sm:col-span-2">
                  ...
                  <div class="mt-2">
                    <input required id="tags" value={formulario.tags} onChange={handleChange} name="tags" type="text" autocomplete="imagem" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                  </div>
